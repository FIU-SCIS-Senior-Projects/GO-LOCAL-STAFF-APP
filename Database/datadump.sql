...
--
INSERT INTO `people` (`peopleID`, `companyID`, `staffType`, `firstName` , `middleInitial`, `lastName`, `nickname`, `email`,`address`,`phone`,`profession`,`website`,`socialMedia`, `pictures`,`dateOfBirth`,`gender`,`languages`,`typeDL`,`ethnicity`,`height`,`weight`,`hairColor`,`eyeColor`,`shirtSize`,`pantSize`,`chestSize`,`waistSize`,`hipSize`,`dressSize`,`shoeSize`,`tattoos`,`piercings`,`desiredHourlyRate`,`desiredWeeklyRate`,`ssnOrEin`,`travel`,`insurance`,`insuranceDocuments`, `bankRouting`, `accountNumber`, `resume` ) VALUES
(1, 1, 1, 'Luis', 'A', 'Castillo', 'Lu', 'luoandre29@hotmail.com','11200 Sw 8 St Miami, FL 33199','123-000-7890',1,'luis.castille.me','luandrecast', 'pictures','11/29/1987',1,'english, spanish', 1, 3, 5.5, 150.0, 'black','brown','M',0,0,0,0,0, 8,0,0,30,3000,'12345678709',1,0,'insuranceDocuments', 'bankRouting', 'accountNumber', 'resume'),
(2, 0, 2, 'Wilfredo', 'G', 'Gomez', 'Willy', 'willyggh@outlook.com','10555 W Flagger St Miami, Fl 33174','098-000-1234',2,'wilfredo.gomez.me','willyggh', 'pictures','4/16/1989',1,'enlish, spanish', 0, 2, 5.6, 160.0, 'black','dark brown',0,0,0,0,0,0,9,0,0,35,3000,'12345678709',0,1,'insuranceDocuments', 'bankRouting', 'accountNumber', 'resume');
