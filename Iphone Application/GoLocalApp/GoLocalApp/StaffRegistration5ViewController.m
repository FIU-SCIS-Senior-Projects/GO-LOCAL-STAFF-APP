...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if([segue.identifier isEqualToString:@"cateringCompanyToOtherServices"]){
        ...
        controller.liveBandDescription      = self.self.liveBandDescription;  //view controller 4
        controller.liveBandWebsite          = self.liveBandWebsite;
        controller.liveBandSocialMedia      = self.liveBandSocialMedia;
        
        controller.cateringCompanyDescription   = self.cateringCompanyDescription.text;  //view controller 5
